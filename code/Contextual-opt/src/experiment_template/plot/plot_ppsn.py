...
if __name__ == '__main__':
    ...
    for i in range(3):
        ...
        if i == 1 :
            ax[i].legend((p3[0],p6[0],p4[0],p5[0],p7[0]), ("Proposed","Proposed (model output)","CMA-ES","Contextual CMA-ES","WS-CMA-ES"),ncol=5,loc='upper center', bbox_to_anchor=(.4, -.3),fontsize="x-large")
        ...
        # if i == 2 :
            # ax[i].legend((p3[0],p6[0],p4[0],p5[0],p7[0]), ("Proposed","Proposed (model output)","CMA-ES","Contextual CMA-ES","WS-CMA-ES"),ncol=1,loc='center right', bbox_to_anchor=(2.2, .5),fontsize="x-large")
