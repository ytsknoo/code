...
for i in range(experiment_times):
    ...
    f2 = bench.FechSlide(max_eval=5e3,log_video=True)
    f2.set_video_name("CCMA-ES")
    # f = bench.FechSlide(max_eval=5e3,log_video=False)
    ...
    param = np.array([-0.08,-0.03,0.15,0.2])
    f2._evaluation(opt.compute_mean(param),param)
# log = [0.12767539,0.1231143,0.17316538,0.12929638,0.12196749,0.14233481,0.11957056,0.13132325,0.12262108,0.15629312]
# print(log)
